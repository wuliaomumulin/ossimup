...
class Configsystem extends Model
{
    ...
    protected $_validate5 = array(
        ...
        array('backup_day', 'checkerInt', '要保留在文件系统中的备份文件数不是整数！', 1,'function',3),
        array('backup_events', 'checkHave', '要保存在数据库中的事件(事件数量)不能为空！',1,'function',3),
        array('backup_events', 'checkerInt', '要保留在文件系统中的备份文件数不是整数！', 1,'function',3),
    ...
    protected $_validate8 = array(
        ...
        array('port', 'checkHave', '事件转发服务器地址不能为空！',1,'function',3),
