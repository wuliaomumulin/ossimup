...
class Configemplement extends Model
{
    ...
    protected $_validate = array(
        ...
        array('company', 'checkLength', '集团名称不得超出于50字符', 1, 'function',3),
        array('factory', 'checkHave', '厂站名称不能为空！',1,'function',3),
        array('factory', 'checkLength', '厂站名称不得超出于50字符', 1, 'function',3),
        array('nick_name', 'checkHave', '厂站简称不能为空！',1,'function',3),
        array('nick_name', 'checkLength', '厂站简称不得超出于50字符', 1, 'function',3),
        array('address', 'checkHave', '地址不能为空！',1,'function',3),
        array('address', 'checkLength', '地址不得超出于50字符', 1, 'function',3),
        array('factory_person', 'checkHave', '电厂负责人不能为空！',1,'function',3),
        array('factory_person', 'checkLength', '电厂负责人不得超出于50字符', 1, 'function',3),
    ...
    protected $_validate1 = array(
        ...
        array('contact', 'checkLength', '实施组长不得超出于50字符', 1, 'function',3),
