...
//require_once 'provider.inc';
     ...
     * @link        http://www.alienvault.com/
     */
class providers_Syetem
{

    /*****************************************************************
     ******************* NETWORK INTERFACES **************************
     *****************************************************************/
    public function a(){echo 123;die;}
  ...
  "status": "success"
     ...
     * @return object
     */
    public function set_auto_update($enabled = FALSE)
    {
        $params = array("enabled" => ($enabled) ? 1 : 0);
    ...
    /**
     * This method get telemetry collection
     *
     * @return object
     */
    public function get_telemetry()
    {
        $response = $this->conn->do_request('/system/telemetry', array(), 'GET');
    ...
    /**
     * This method set telemetry collection true/false
     *
     * @return object
     */
    public function set_telemetry($enabled = FALSE)
    {
        $params = array("enabled" => ($enabled) ? 1 : 0);

        $response = $this->conn->do_request('/system/telemetry', $params, 'PUT');
     ...
     * @return object
     */
    public function get_audit_backup_list($system_id)
    {
        $params = array();
        $response = $this->conn->do_request('/system/audit_backup_restore/'.$system_id.'/audit_backup', $params, 'GET');
        return $response;
    }

    public function restore_audit_backup_list($system_id,$file)
    {
        $params = array();
        $response = $this->conn->do_request('/system/audit_backup_restore/'.$system_id.'/audit_restore/'.$file, $params, 'GET');
        return $response;
    }
    ...
    public function get_backup_list($system_id, $type)
    {
        ...
        $response = $this->conn->do_request('/system/'.$system_id.'/audit_backup', $params, 'GET');
    ...
    {
        $response = $this->conn->do_request("/system/$system_id/status/ready_for_update", 'GET');
        return $response;
    }

    public function get_audit_list($system_id){
        $params = array();
